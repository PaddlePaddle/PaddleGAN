...
# 解压数据
# AI studio跑一次即可
# run the following line once if in AI Studio environment
...
# ------------------------------------------
# 第二步 定义数据读取器
# Step 2: define data load (PairedData)
# ------------------------------------------
...
# path to be modified if not run in AI Studio
...
for epoch in range(EPOCHS):
    for data in tqdm(data_loader_train):
        ...
        g_bce_loss = bce_loss(g_fake_predict, paddle.zeros_like(g_fake_predict))
...
# ------------------------------------------
# 第七步 测试
# Step 7: test the generator with new samples
# ------------------------------------------
