...
__all__ = [
    ...
    'NewMSRAInitializer', 'NumpyArrayInitializer', 'set_global_initializer'
]
...
class NewMSRAInitializer(Initializer):
    ...
    def __init__(self, uniform=True, fan_in=None, seed=0):
        ...
        assert uniform is not None
        assert seed is not None
        super(NewMSRAInitializer, self).__init__()
        self._uniform = uniform
        self._fan_in = fan_in
        self._seed = seed
