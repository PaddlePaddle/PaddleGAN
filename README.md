...
GAN--生成对抗网络，被“卷积网络之父”**Yann LeCun（杨立昆）**誉为**「过去十年计算机科学领域最有趣的想法之一」**，是近年来火遍全网，AI研究者最为关注的深度学习算法方向之一。
...
<div align='center'>
  <img src='./docs/imgs/color_sr_peking-2.gif' width='700'/>
</div>
...
[Paddle SIG成员及贡献机制详细介绍](./docs/zh_CN/PaddleGAN-SIG.pdf)
