...
**说明**：其中`C++`预测代码在`/root/projects/PaddleGAN/deploy/cpp` 目录，该目录不依赖任何`PaddleGAN`下其他目录。
...
./build/main --model_dir=/root/projects/models/multistagevsrmodel_generator --config_dir=/root/projects/models/infer_cfg.yml --video_file=/root/projects/images/test.mp4 --device=GPU
```
